...
static struct fb_videomode lcdif_modedb[] = {
	...
	0,},
	{
	/* 800x480 @ 50 Hz , pixel clk @ 28MHz */
	"WVGA-GH2", 60, 800, 480, KHZ2PICOS(28000), 100, 100, 56, 15, 5, 10,
	FB_SYNC_CLK_LAT_FALL,
	FB_VMODE_NONINTERLACED,
	0,},
	{
	/* 640x240 @ 50 Hz , pixel clk @ 25MHz */
	"HVGA-GH2", 60, 640, 240, KHZ2PICOS(25000), 48, 16, 31, 11, 96, 2,
	FB_SYNC_CLK_LAT_FALL,
	FB_VMODE_NONINTERLACED,
	0,},
	{
	"EVRV-VGA", 60, 640, 480, KHZ2PICOS(25175), 48, 16, 33, 10, 96, 2,
	FB_SYNC_CLK_LAT_FALL,
	FB_VMODE_NONINTERLACED,
	0,},
	{
...
void lcdif_disable (struct mxc_dispdrv_handle *disp, struct fb_info *fbinfo)
{
	struct mxc_lcdif_data *lcdif = mxc_dispdrv_getdata(disp);
	struct mxc_lcd_platform_data *plat_data
			= lcdif->pdev->dev.platform_data;
