...
static int mxc_hdmi_power_on(struct mxc_dispdrv_handle *disp, struct fb_info *)
{
...
static void mxc_hdmi_power_off(struct mxc_dispdrv_handle *disp, struct fb_info *)
{
	struct mxc_hdmi *hdmi = mxc_dispdrv_getdata(disp);
	mxc_hdmi_phy_disable(hdmi);
}
