...
static const struct i2c_device_id evervision_id[] =
{
	{ "Evervision", 0 },
	{},
};
...
{
	.probe      = evervision_probe,
	.remove     = evervision_remove,
	.id_table   = evervision_id,
	.driver     = {
		.name   = "Evervision",
	},
};
...
static int __devinit evervision_init(void)
{
   	int result;
	int err = 0;
